...
**ALL communication and documentation MUST be in Portuguese Brasileiro (pt-BR).**

- Always communicate with the user in pt-BR
- All standards files must be written in pt-BR
- Code examples may use English for technical terms, but comments should be in pt-BR
